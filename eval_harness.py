...
DEFAULT_TASKS = "arc_challenge,arc_easy,hellaswag,winogrande,ifeval,gsm8k,minerva_math"  #,mmlu"
...
_METRIC_PRIORITY = [
    ...
    "math_verify,none",                 # MATH (minerva_math)
    "pass@1,create_test",               # HumanEval (code generation)
    "pass_at_1,extract_code",           # MBPP (code generation)
]
...
def run_from_args(args: argparse.Namespace) -> None:
    ...
    all_results: dict[str, dict] = lm_results["results"]
